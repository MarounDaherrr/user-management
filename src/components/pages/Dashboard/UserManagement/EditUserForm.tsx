  ...
  const onSubmit: SubmitHandler<UserForm> = async (data) => {
    try {
      ...
      if (response && response.ok) {
        ...
        toast.error(errorData?.result?.message || "Failed to update user.");
      }
    } catch (error) {
    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900">
      ...
      <div className="flex justify-center items-center min-h-screen">
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg w-full sm:w-96">
          <h1 className="text-xl font-semibold mb-4 text-center text-gray-800 dark:text-white">Edit User</h1>
